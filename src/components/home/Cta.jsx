    ...
    <div className=" min-h-[70vh] py-20 w-full padding-x">
        <div className="w-[80vw] border rounded-3xl hero-lg bg-cover border-[#ffffff54] mx-auto min-h-96 flex  flex-col justify-around items-center px-4 md:px-20 text-center  ">
            ...
            <p className="max-w-[550px] text-white max-md:text-xs">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga exercitationem atque officiis vel, inventore pariatur ea iste repudiandae amet architecto porro aliquam quis corrupti magni culpa nesciunt ipsa, sit optio!
            </p>
            <button className=" px-5 rounded-3xl font-semibold py-2 bg-white text-black">
              learn more
            </button>
