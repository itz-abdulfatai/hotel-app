function Rooms() {
  return (
    <div className=" min-h-[70vh] pt-32 w-full padding-x">
        <h2 className="capitalize text-center mb-10 text-2xl md:text-6xl max-md:text-center">Rooms & suites</h2>
        <div className="flex gap-5  flex-wrap mx-auto justify-center">
            ...
            <div className="w-full flex items-center justify-between">
                <button className=" border border-white py-2 px-4 rounded-full hover:bg-white hover:text-black ">book</button>
                <div className="flex gap-1 items-center">3x <i className='bx bx-group'></i></div>
            </div>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
                <button className=" border border-white py-2 px-4 rounded-full hover:bg-white hover:text-black ">book</button>
                <div className="flex gap-1 items-center">1x <i className='bx bx-group'></i></div>
            </div>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
                <button className=" border border-white py-2 px-4 rounded-full hover:bg-white hover:text-black ">book</button>
                <div className="flex gap-1 items-center">4x <i className='bx bx-group'></i></div>
            </div>
            </div>
            <div className=" w-full max-w-[320px] sm:w-[230px] room-card bg-cover bg-left h-72 rounded-2xl bg-accent2 flex flex-col justify-end gap-3 p-3">
